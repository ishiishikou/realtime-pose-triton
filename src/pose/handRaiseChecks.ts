...
const HEAD_CLEARANCE_RATIO = 0.015;
const MIN_HEAD_CLEARANCE_PX = 4;

export const HAND_RAISE_CHECKS = [
  {
    id: 'rightOnly',
    label: '右手のみを頭の上より高く上げる',
    description: '右手首だけが頭部の最上点より上にある状態',
  },
  {
    id: 'leftOnly',
    label: '左手のみを頭の上より高く上げる',
    description: '左手首だけが頭部の最上点より上にある状態',
  },
  {
    id: 'bothHands',
    label: '両手を頭の上より高く上げる',
    description: '左右の手首がどちらも頭部の最上点より上にある状態',
  },
] as const;
